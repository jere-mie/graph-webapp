...
class ChordalGraph:
    ...
    def __init__(self, noNodes, noEdges):
        ...
        self.chordalTree = {}
        self.prev_card = 0
        self.L = [[] for _ in xrange(noNodes+2)]
        self.s = 0
        self.cliqueTree = {}
    ...
    def createCT(self, graphToCT):
        ...
        if graphToCT:
            ...
            V = []
            for key,value in graphToCT.iteritems():
                V.append(key)
            ...
            for i in reversed(V):
                ...
                if new_card <= self.prev_card:
                    ...
                    if new_card != 0:
                        k = self.findMin(Ks)
                        for key, value in self.cliqueTreeNames.items():
                            if k in value:
                                p = key
    ...
    def findMin(self, Ks):
        ...
        return labelsDict.keys()[labelsDict.values().index(minV[0])]
    ...
    def createCGByDeletion(self):
        ...
        while numberOfEdgesToBeDeleted > 0:
            ...
            for x, Nx in self.cliqueTree.iteritems():
    ...
    def dfsCaller(self):
        ...
        if len(self.cliqueTree) == 1:
            ...
            for node, neighbors in self.cliqueTree.iteritems():
    ...
    def printInfo(self, graphToDraw):
        ...
        cliqueSize = []
        for k, v in self.cliqueTreeNames.iteritems():
